      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-lg p-10 rounded-2xl bg-white/80 backdrop-blur-sm shadow-xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-semibold text-green-400 mb-2">Create New Password</h1>
            <h2 className="text-xl font-medium text-gray-700 mb-3">Secure Your Account</h2>
            <p className="text-sm text-gray-600">
              To help keep your account safe, create a strong password<br />that meets all the requirements below
            </p>
          </div>
