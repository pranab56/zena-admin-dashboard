  ...
  return (
    <div className="sm:px-0 space-y-5">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-400 text-[15px]">{t('created_since', { date: 'Oct 12, 2023' })}</p>
      </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          <Card className="bg-[#F8F8F8] border-none rounded-3xl p-1 shadow-none h-full">
            <CardContent className="p-6 sm:p-8 flex flex-col justify-center h-full">
              <h3 className="text-[13px] font-bold text-gray-500 tracking-wider uppercase mb-4">{t('total_active_members')}</h3>
          ...
          <Card className="bg-[#F8F8F8] border-none rounded-3xl p-1 shadow-none h-full">
            <CardContent className="p-6 sm:p-8 flex flex-col justify-center h-full">
              <h3 className="text-[13px] font-bold text-gray-500 tracking-wider uppercase mb-4">{t('points_issued')}</h3>
